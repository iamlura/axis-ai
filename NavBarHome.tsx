import svgPaths from "./svg-atxt4vm5pv";

export default function NavBarHome() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] content-stretch flex gap-[30px] items-center opacity-70 p-[8px] relative rounded-[50px] size-full" data-name="nav bar home">
